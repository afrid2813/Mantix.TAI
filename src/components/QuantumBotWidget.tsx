...
export function QuantumBotWidget({
  ...
  // VPS MT5 Integration - Open Positions
  useEffect(() => {
  ...
  // Update existing positions PnL (Deactivated for VPS)
  useEffect(() => {
    // mtBalance and positions are handled by external polling
  }, [currentPrice]);
    ...
    <div className="flex flex-col h-full relative overflow-hidden bg-[#0A0A0E]">
      ...
      <div className="px-4 py-3 border-b border-[#00FFFF]/20 bg-black/40 flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[9px] font-mono text-brand-red font-bold animate-pulse">
            LIVE MT5
          </span>
        </div>
      </div>
      ...
      <div className="p-4 flex-1 flex flex-col gap-4 z-10 overflow-y-auto custom-scrollbar">
        ...
        <div className="flex flex-col gap-3 mb-1">
          ...
          <div className="flex flex-col gap-2 p-3 bg-black/40 border border-white/5 rounded-md">
            ...
            className="w-full h-1 bg-gray-800 rounded-lg appearance-none cursor-pointer accent-[#00FFFF]"
          />
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-gray-500 font-bold ml-1">{lot_size} LOTS</span>
                    </div>
